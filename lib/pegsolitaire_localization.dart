...
class EasyPegSolitaireLocalizations {
  ...
  static String translate(BuildContext context, String key) {
    return Localizations.of<EasyPegSolitaireLocalizations>(context, EasyPegSolitaireLocalizations).getTranslation(key);
  }
  ...
  static Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'winningIconText': 'This is the winning icon. A smiley indicates that you can still win the game.',
      'continue': 'Continue',
    ...
    'de': {
      ...
      'winningIconText': 'Dieses Icon zeigt an ob das Spiel noch gewonnen werden kann oder schon verloren ist.',
      'continue': 'Weiter',
...
class EasyPegSolitaireLocalizationsDelegate extends LocalizationsDelegate<EasyPegSolitaireLocalizations> {
  ...
  Future<EasyPegSolitaireLocalizations> load(Locale locale) {
    return SynchronousFuture<EasyPegSolitaireLocalizations>(new EasyPegSolitaireLocalizations(locale));
  }
